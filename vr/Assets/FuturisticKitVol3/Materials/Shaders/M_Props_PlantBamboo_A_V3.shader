Shader "Unreal/M_Props_PlantBamboo_A_V3"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Props_GPBamboo_A_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Props_GPBamboo_A_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_Props_GPBamboo_A_MAS", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Props_PlantBamboo_A_V3.hlsl"
