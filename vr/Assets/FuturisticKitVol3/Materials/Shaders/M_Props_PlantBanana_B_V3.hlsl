...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.014708,0.046875,0.008545,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[1].w = __SubsurfaceProfile;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local9 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[1].w);
