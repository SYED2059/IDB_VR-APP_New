Shader "Unreal/M_Sky_Panning_Clouds2"
{
    Properties
    {
		...
		Zenith_Color( "Zenith_Color", Color ) = (0.085177, 0.153746, 0.350000, 1.000000 )
		Stars_brightness( "Stars_brightness", Float ) = 0.100000
		Sun_height( "Sun_height", Float ) = 1.000000
		Horizon_color( "Horizon_color", Color ) = (0.940601, 1.000000, 1.000000, 1.000000 )
		Horizon_Falloff( "Horizon_Falloff", Float ) = 3.000000
		Light_direction( "Light_direction", Vector ) = (-2.000000, 0.000000, -1.000000, 1.000000 )
		Sun_Radius( "Sun_Radius", Float ) = 0.000300
		Sun_color( "Sun_color", Color ) = (1.000000, 0.800000, 0.400000, 1.000000 )
		Sun_brightness( "Sun_brightness", Float ) = 50.000000
		Cloud_color( "Cloud_color", Color ) = (0.716850, 0.782221, 0.885000, 0.000000 )
		Cloud_speed( "Cloud_speed", Float ) = 0.100000
		Cloud_opacity( "Cloud_opacity", Float ) = 1.000000
		NoisePower1( "NoisePower1", Float ) = 1.000000
		NoisePower2( "NoisePower2", Float ) = 4.000000
		Overall_Color( "Overall_Color", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
