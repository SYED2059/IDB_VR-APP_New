Shader "Unreal/M_Props_Painting_E_V3"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_Props_Painting_A_Props_Painting_E_BaseColor_V3_BC", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Props_Painting_E_V3.hlsl"
