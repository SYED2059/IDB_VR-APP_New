...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat2 Local1 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)0.05000000));
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local5 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);
	...
	MaterialFloat4 Local10 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
