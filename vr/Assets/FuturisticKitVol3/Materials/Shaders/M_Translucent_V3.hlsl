...
uniform float Roughness_Intensity;
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.500000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.500000,1.520000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].xyz = Emissive_Color.xyz * Emissive_Intensity;
	Material.PreshaderBuffer[0].w = SelectionColor.w;
	Material.PreshaderBuffer[1].xyz = SelectionColor.xyz;
	Material.PreshaderBuffer[1].w = Specular_Intensity;
	Material.PreshaderBuffer[2].x = Roughness_Intensity;
	Material.PreshaderBuffer[2].y = Opacity_Intensity;
	Material.PreshaderBuffer[2].z = IOR;
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local9 = lerp(1.00000000,Material.PreshaderBuffer[2].z,Local8);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[2].y;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(0.01298303,0.01298303,0.01298303);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local9,0.0f),Material.PreshaderBuffer[2].w);
