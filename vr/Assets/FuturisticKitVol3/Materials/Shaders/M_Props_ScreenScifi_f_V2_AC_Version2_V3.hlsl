...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1].x = RefractionDepthBias;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local7 = (Local5.rgb * ((MaterialFloat3)10.00000000));
	...
	MaterialFloat4 Local13 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	...
	PixelMaterialInputs.Roughness = Local13.g;
