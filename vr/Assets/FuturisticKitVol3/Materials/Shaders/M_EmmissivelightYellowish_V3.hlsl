...
{
	Material.PreshaderBuffer[0] = float4(4.735401,5.000000,2.760417,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].xyz = color_5.xyz * emmissive;
