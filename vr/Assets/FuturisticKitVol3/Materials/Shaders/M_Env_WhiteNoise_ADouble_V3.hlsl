...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local3 = (View.GameTime * 25.00000000);
	FWSVector2 Local4 = MakeWSVector(WSGetY(DERIV_BASE_VALUE(Local1)), WSGetZ(DERIV_BASE_VALUE(Local1)));
	FWSVector2 Local5 = WSAdd(MaterialFloat2(Local3,Local3), DERIV_BASE_VALUE(Local4));
	FWSVector3 Local6 = MakeWSVector(WSPromote(DERIV_BASE_VALUE(Local2)),WSPromote(DERIV_BASE_VALUE(Local5)));
	MaterialFloat Local7 = MaterialExpressionNoise(WSDemote(DERIV_BASE_VALUE(Local6)),0.02000000,1.00000000,2.00000000,1.00000000,6.00000000,-0.50000000,1.00000000,1.00000000,0.00000000,0.00000000,512.00000000);
	MaterialFloat Local8 = (1.00000000 - Local7);
	MaterialFloat Local9 = PositiveClampedPow(Local8,4.00000000);
	MaterialFloat3 Local10 = (((MaterialFloat3)Local9) * MaterialFloat3(0.23894100,0.61407000,1.00000000).rgb);
	MaterialFloat3 Local11 = lerp(Local10,Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);

	PixelMaterialInputs.EmissiveColor = Local11;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(0.97670799,1.00000000,0.98968703).rgb;
