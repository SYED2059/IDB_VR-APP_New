Shader "Unreal/M_Rotating_Seat_AA_V3"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Rotating_seat_unscale_Rotating_Seat_AA_Normal_V3_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Rotating_seat_unscale_Rotating_Seat_AA_Emissive_V3_E", 2D ) = "white" {}
		Material_Texture2D_2( "T_Rotating_seat_unscale_Rotating_Seat_AA_BaseColor_V3_BC", 2D ) = "white" {}
		Material_Texture2D_3( "T_Rotating_seat_unscale_Rotating_Seat_AA_OcclusionRoughnessMetallic_V3_ORM", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Rotating_Seat_AA_V3.hlsl"
