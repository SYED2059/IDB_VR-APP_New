Shader "Unreal/M_Env_ScifiWhite_A_2DoubleSided_V3"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Planeref_Env_ScifiWhite_A_Normal_V3_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Planeref_Env_ScifiWhite_A_BaseColor_V3_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_Planeref_Env_ScifiWhite_A_OcclusionRoughnessMetallic_V3_ORM", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Env_ScifiWhite_A_2DoubleSided_V3.hlsl"
