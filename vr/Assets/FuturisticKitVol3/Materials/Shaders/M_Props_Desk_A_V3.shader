Shader "Unreal/M_Props_Desk_A_V3"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Props_Desk_A_Normal_V3_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Props_Desk_A_Emissive_V3_E", 2D ) = "white" {}
		Material_Texture2D_2( "T_Props_Desk_A_BaseColor_V3_BC", 2D ) = "white" {}
		Material_Texture2D_3( "T_Props_Desk_A_OcclusionRoughnessMetallic_V3_ORM", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Props_Desk_A_V3.hlsl"
