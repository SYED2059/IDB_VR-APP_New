...
{
	Material.PreshaderBuffer[0] = float4(0.060531,0.444234,0.875000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].xyz = Param.xyz;
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local7 = (Material.PreshaderBuffer[0].xyz * Local5.rgb);
	MaterialFloat3 Local8 = lerp(Local7,Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].w);
	...
	MaterialFloat3 Local12 = (Material.PreshaderBuffer[0].xyz * Local10.rgb);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local14 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 1);

	PixelMaterialInputs.EmissiveColor = Local8;
	PixelMaterialInputs.Opacity = Local10.a;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local12;
	PixelMaterialInputs.Metallic = Local14.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local14.g;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local2.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local14.r;
