Shader "Unreal/M_Translucent_V3"
{
    Properties
    {
		...
		Emissive_Color( "Emissive_Color", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Emissive_Intensity( "Emissive_Intensity", Float ) = 0.000000
		Specular_Intensity( "Specular_Intensity", Float ) = 0.500000
		Roughness_Intensity( "Roughness_Intensity", Float ) = 0.000000
		Opacity_Intensity( "Opacity_Intensity", Float ) = 0.500000
		IOR( "IOR", Float ) = 1.520000
