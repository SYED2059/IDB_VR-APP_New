...
namespace Fragilem17.MirrorsAndPortals
{
    ...
    public class MirrorRenderer : MonoBehaviour
    {
		...
		[Tooltip("When checked, the reflection camera will have the layerindex defined by ReflectionCameraLayerIndex instead of taking the one from the source camera")]
		public bool ChangeReflectionCameraLayer = false;
		public int ReflectionCameraLayerIndex = 0;
		...
		public Camera CurrentReflectionCamera { get => _reflectionCamera; }
        ...
        private void UpdateCamera(UnityEngine.Rendering.ScriptableRenderContext src, Camera renderCamera)
        {
            ...
            if (ChangeReflectionCameraLayer) { 
                _reflectionCamera.gameObject.layer = ReflectionCameraLayerIndex;
			}
